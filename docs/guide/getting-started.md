...
This walkthrough assumes SurvNG is already installed and reachable in a browser. If you still need to install it, use the project [README](https://github.com/InstigatorX/SurvNG/blob/v1.1/README.md) or the [Docker installation](../docker.md) notes, then return here.
