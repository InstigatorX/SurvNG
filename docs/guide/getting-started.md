...
([Docker](https://github.com/InstigatorX/SurvNG/blob/v1.0/README.install.docker.md)
or
[systemd](https://github.com/InstigatorX/SurvNG/blob/v1.0/README.install.systemd.md)),
