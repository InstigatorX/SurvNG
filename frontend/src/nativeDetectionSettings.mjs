...
export const NATIVE_DETECTION_FIELDS = [
  ...
  { path: "native.inference_interval", label: "Inference interval", initial: 1, min: 1, max: 5, step: 1, integer: true, group: "detection", help: "Run gvadetect every Nth sampled frame. At 5 FPS, interval 2 targets 2.5 fresh detections/sec; skipped frames cannot create or extend incidents." },
