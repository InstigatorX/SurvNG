        ...
        <div className="detection-settings subsection-workspace">
          ...
          {detectionSection === "faces" ? <details className="detection-settings-card detection-feature-card wide-card" open>
            ...
            <div className="detection-feature-body detection-field-grid">
              ...
              <label>Fused Suggestion Threshold<input type="number" min="0" max="1" step="0.01" value={config.detector?.people_fused_match_threshold ?? 0.45} onChange={(event) => updateConfig(["detector", "people_fused_match_threshold"], Number(event.target.value))} /></label>
              ...
              <label>Automatic Fused Threshold<input type="number" min="0" max="1" step="0.01" value={config.detector?.people_fused_auto_threshold ?? 0.62} onChange={(event) => updateConfig(["detector", "people_fused_auto_threshold"], Number(event.target.value))} /><small>Requires face+body agreement. Body-only never auto-identifies.</small></label>
