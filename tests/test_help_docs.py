...
class HelpDocsTest(unittest.TestCase):
    def test_guide_home_and_pages_are_served(self) -> None:
        ...
        self.assertIn("Documentation", home.text)
    ...
    def test_reference_docs_are_served(self) -> None:
        ...
        self.assertIn("Additional detail for this topic", response.text)
    ...
    def test_help_stylesheet_is_served(self) -> None:
        ...
        self.assertIn("help-figure", home.text)
        self.assertIn("/help/assets/images/live-command-center.png", home.text)

    def test_guide_images_are_served(self) -> None:
        client = TestClient(app)
        response = client.get("/help/assets/images/live-command-center.png")
        self.assertEqual(response.status_code, 200)
    ...
    def test_markdown_links_rewrite_to_help_routes(self) -> None:
        ...
        self.assertEqual(
            _rewrite_href("images/live-command-center.png", "/survng"),
            "/survng/help/assets/images/live-command-center.png",
        )
    ...
    def test_markdown_renderer_handles_basics(self) -> None:
        html_body = _markdown_to_html(
            ...
            "![Live grid](images/live-command-center.png)\n\n"
            "- one\n- two\n\n"
            "| A | B |\n| --- | --- |\n| 1 | 2 |\n\n```bash\necho hi\n```\n",
            "/survng",
        )
        ...
        self.assertIn('src="/survng/help/assets/images/live-command-center.png"', html_body)
