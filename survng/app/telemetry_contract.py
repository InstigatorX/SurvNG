...
CAMERA_METRICS: tuple[MetricDefinition, ...] = (
    ...
    MetricDefinition("detection_fps", MetricKind.GAUGE, "frames_per_second"),
    MetricDefinition("detector_latency_ms", MetricKind.GAUGE, "milliseconds"),
    MetricDefinition("detector_p95_ms", MetricKind.GAUGE, "milliseconds"),
