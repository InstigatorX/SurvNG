...
class InferenceSupervisor:
    ...
    def _base_face_status(self) -> dict[str, Any]:
        return {
            ...
            "device": self.config.resolved_face_recognition_device(),
    ...
    def _base_reid_status(self) -> dict[str, Any]:
        return {
            ...
            "device": self.config.tracking.resolved_reid_device(),
            ...
            "vehicle": {
                ...
                "ready": False,
                "device": self.config.tracking.resolved_vehicle_reid_device(),
    ...
    def _base_depth_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "configured_device": depth.resolved_device(),
            "loaded_device": "",
