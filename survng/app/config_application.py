...
HOT_CONFIG_FIELDS = frozenset({"base_path", "event_clip_before_seconds", "event_clip_after_seconds", "incident_thumbnail_annotations", "image_storage", "recording_cache_max_gb", "recording_cache_max_days", "recording_cache_prewarm", "api_auth", "audit_ai", "mqtt", "retention", "semantic_search"})
RECORDER_CONFIG_FIELDS = frozenset({"ffmpeg_path", "hardware_acceleration", "recording_segment_seconds"})
DETECTOR_HOT_POLICY_FIELDS = frozenset({"confidence_threshold", "event_candidate_confidence_threshold", "event_confirmation_frames", "event_class_confirmation_frames", "event_class_confidence_thresholds", "object_activity_attribution", "require_incident_zone", "max_concurrent_refinements", "recorded_decode_max_processes", "recorded_decode_memory_budget_mb", "recorded_decode_estimated_frame_mb", "face_max_observations", "face_detection_threshold", "face_match_threshold", "face_unknown_cluster_threshold", "face_auto_identify_enabled", "face_auto_identify_threshold", "face_auto_identify_margin", "face_min_size", "face_max_references"})
