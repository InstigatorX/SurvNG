...
HOT_CONFIG_FIELDS = frozenset({"base_path", "event_clip_before_seconds", "event_clip_after_seconds", "incident_thumbnail_annotations", "image_storage", "recording_cache_max_gb", "recording_cache_max_days", "recording_cache_prewarm", "api_auth", "web_auth", "tls", "proxy", "audit_ai", "mqtt", "retention", "semantic_search"})
