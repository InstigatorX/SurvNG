...
DETECTOR_HOT_POLICY_FIELDS = frozenset({"confidence_threshold", "event_confirmation_frames", "event_class_confirmation_frames", "event_class_confidence_thresholds", "require_incident_zone", "face_max_observations", "face_match_threshold", "face_min_size", "face_max_references"})
...
DETECTOR_OBJECT_ENGINE_FIELDS = frozenset({"enabled", "backend", "model_path", "model_xml", "coreml_model_path", "labels_path", "device", "nms_threshold", "warmup_enabled", "labels"})
...
DETECTOR_FACE_ENGINE_FIELDS = frozenset({"face_recognition_enabled", "face_embedding_model_path", "face_landmark_model_path", "face_recognition_device"})
